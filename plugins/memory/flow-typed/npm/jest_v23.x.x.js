...
declare var it: {
   ...
   */
  each(table: Array<Array<mixed>>): (name: JestTestName, fn?: (...args: Array<any>) => ?Promise<mixed>) => void,
  /**
   * Only run this test
   *
   * @param {JestTestName} Name of Test
...
declare var expect: {
  ...
  (value: any): JestExpectType & JestPromiseType & EnzymeMatchersType & DomTestingLibraryType & JestJQueryMatchersType & JestStyledComponentsMatchersType & JestExtendedMatchersType,
